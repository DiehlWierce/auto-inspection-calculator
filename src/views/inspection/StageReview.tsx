...
import { CostField } from '../../ui/CostField';
...
import { resolvePriceRange } from '../../calc/repairTypes';
import type { AppConfig, CalculatedFact, Fact, FactUrgency, ModelId } from '../../types';

export function StageReview({ stage, stepIndex, facts, config, modelId, onSaveFact, onDeleteFact, onOpenPriceBook }: { stage: InspectionStage; stepIndex: number; facts: CalculatedFact[]; config: AppConfig; modelId: ModelId; onSaveFact: (fact: Fact) => void; onDeleteFact: (id: string) => void; onOpenPriceBook?: () => void }) {
