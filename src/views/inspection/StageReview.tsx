...
import type { AppConfig, CalculatedFact, Fact, FactUrgency } from '../../types';

export function StageReview({ stage, stepIndex, facts, config, onSaveFact, onDeleteFact, onOpenPriceBook }: { stage: InspectionStage; stepIndex: number; facts: CalculatedFact[]; config: AppConfig; onSaveFact: (fact: Fact) => void; onDeleteFact: (id: string) => void; onOpenPriceBook?: () => void }) {
