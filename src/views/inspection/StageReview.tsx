...
export function StageReview({ stage, stepIndex, facts, config, onSaveFact, onDeleteFact }: { stage: InspectionStage; stepIndex: number; facts: CalculatedFact[]; config: AppConfig; onSaveFact: (fact: Fact) => void; onDeleteFact: (id: string) => void }) {
